...
if (isset($_GET['id_pet'])) {
    ...
    $current_image = str_replace('C:/laragon/www/posttest7/', '', $data_pet['path_poto']);
...
<div class="container-form ">
    <div class="title">
        <h2>Edit Pet</h2>
        <a href="admin.php"><button class="btn-edit"><i class="fa-solid fa-door-open"></i> Back</button></a>
    </div>
